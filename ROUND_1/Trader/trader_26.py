# trader.py - The Proven 5,023 PnL Algorithm (Error‑Free)
...
class Trader:
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        # =========================================================================
        # PROVEN CONFIGURATION – EXACTLY AS 5,023 RUN
        # =========================================================================
        CONFIG = {
            "ASH_COATED_OSMIUM": {
                "fair_initial": 9984,
        ...
        for product, od in state.order_depths.items():
            ...
            # ----- Inventory pressure (reduce if too large) -----
