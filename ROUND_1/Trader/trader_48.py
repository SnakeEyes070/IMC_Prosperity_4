# trader.py - Ultimate Final (Target: 7,500+)
# Pepper endgame starts even earlier (95,000) for zero-slippage unwind.
# Pepper buy tolerance slightly widened (18) for guaranteed instant max long.
...
class Trader:
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # PEPPER – Ultimate precision
    # ─────────────────────────────────────────────────────────────────────────
    PEPPER_SLOPE     = 0.001
    PEPPER_BUY_TOL   = 18          # Slightly wider for guaranteed instant fill

    # ─────────────────────────────────────────────────────────────────────────
    # OSMIUM – Proven perfect, unchanged
    # ─────────────────────────────────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # TIMING – Earlier unwind for zero slippage
    # ─────────────────────────────────────────────────────────────────────────
    ROUND_DAYS       = 3
    MAX_TS           = 99_900
    ENDGAME_START    = 95_000      # Even earlier for perfect smooth exit
    ...
    # ══════════════════════════════════════════════════════════════════════════
    #  OSMIUM (Unchanged – already perfect)
    # ══════════════════════════════════════════════════════════════════════════
