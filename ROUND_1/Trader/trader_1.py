...
class Trader:
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        CONFIG = {
            "ASH_COATED_OSMIUM": {
                "fair_initial": 9984,
                "ema_alpha": 0.2,                # Faster adaptation
                "spread_alpha": 0.3,             # Volatility tracking
                "base_offset": 3,                # Tight: get filled
                "base_size": 15,                 # Aggressive size
                "take_thresh": 80,               # Fade 0.8% moves
                "momentum_thresh": 30,           # Don't trade against momentum >30 ticks
                "inventory_cap": 0.35,           # Allow larger positions
                "endgame_start": 194000          # Flatten very late
            },
            "INTARIAN_PEPPER_ROOT": {
                "fair_initial": 11479,
                "ema_alpha": 0.25,               # Even faster for volatile asset
                "spread_alpha": 0.35,
                "base_offset": 4,                # Tight enough
                "base_size": 12,                 # Aggressive
                "take_thresh": 200,              # Fade ~1.7% moves
                "momentum_thresh": 80,
                "inventory_cap": 0.30,
                "endgame_start": 194000
            }
        }
