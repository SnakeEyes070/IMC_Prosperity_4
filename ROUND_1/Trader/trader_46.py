# trader.py - Final Calibrated (Peak 6,253 + Precision Tweaks)
# Pepper endgame starts earlier (97,000) for smoother unwind.
# Osmium MR threshold tightened to 6, L1 size increased to 18, skew factor 0.08.
...
class Trader:
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # PEPPER – Unchanged core, only endgame timing adjusted
    # ─────────────────────────────────────────────────────────────────────────
    PEPPER_SLOPE     = 0.001
    PEPPER_BUY_TOL   = 15

    # ─────────────────────────────────────────────────────────────────────────
    # OSMIUM – Precision improvements
    # ─────────────────────────────────────────────────────────────────────────
    ...
    OSM_L1_SIZE      = 18          # Increased from 15
    OSM_L2_SIZE      = 12
    OSM_L3_SIZE      = 8

    OSM_MR_THRESH    = 6           # Tightened from 8
    OSM_MR_MAX_QTY   = 20

    OSM_SKEW_FACTOR  = 0.08        # Increased from 0.06
    ...
    ROUND_DAYS       = 3
    MAX_TS           = 99_900
    ENDGAME_START    = 97_000      # Earlier unwind (was 99,000)
    ...
    # ══════════════════════════════════════════════════════════════════════════
    #  PEPPER (unchanged except endgame start is earlier via parameter)
    # ══════════════════════════════════════════════════════════════════════════
    ...
    # ══════════════════════════════════════════════════════════════════════════
    #  OSMIUM – Calibrated improvements
    # ══════════════════════════════════════════════════════════════════════════
    ...
    def _osmium_orders(self, state: TradingState, data: dict) -> List[Order]:
        ...
        # Aggressive take with tighter threshold
        ...
        # Passive 3‑level ladder with stronger skew
