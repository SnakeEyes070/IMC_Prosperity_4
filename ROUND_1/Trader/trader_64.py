# trader.py - Enhanced: Volume‑Weighted Pepper Anchor + Larger Osmium Sizes + Imbalance Filter
import json
import math
...
class Trader:
    ...
    ROUND_DAYS       = 3
    MAX_TS           = 99_900
    ENDGAME_START    = 96_500      # Slightly earlier unwind (proven beneficial)
    ...
    def _pepper_anchor(self, state: TradingState) -> float:
        """Volume‑weighted average of top 3 asks for more accurate fair value."""
    ...
    def _osmium_orders(self, state: TradingState, data: dict) -> List[Order]:
        ...
        # Order book imbalance (prevents trading into strong pressure)
        ...
        for offset, base_size in levels:
            ...
            # Apply imbalance filter: skip if pressure is strongly against us
