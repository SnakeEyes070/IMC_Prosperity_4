# trader.py - Safe Multi‑Day Reset (Target: 8,000+)
...
class Trader:
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        # =====================================================================
        # INTARIAN PEPPER ROOT — Aggressive Accumulation + Timestamp Reset
        # =====================================================================
        if PEPPER in state.order_depths:
            ...
            if od.buy_orders and od.sell_orders:
                ...
                # Reliable day reset: timestamp jumps backward
                ...
                # If timestamp decreased, it's a new day → reset anchor
        ...
        # =====================================================================
        # ASH_COATED_OSMIUM — Proven 5,833 Parameters (Unchanged)
        # =====================================================================
        OSM_FAIR        = 10000.0
        OSM_MM_OFFSET   = 3
        OSM_MM_SIZE     = 14
