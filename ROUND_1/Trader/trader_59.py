# trader.py - Rollback to Proven Baseline + Early Unwind
import json
import math
...
class Trader:
    ...
    # ── PEPPER ────────────────────────────────────────────────────────────
    PEPPER_SLOPE   = 0.001
    PEPPER_BUY_TOL = 15             # restored

    # ── OSMIUM ────────────────────────────────────────────────────────────
    OSM_FAIR_FALLBACK = 10_000
    OSM_EMA_ALPHA    = 0.015
    OSM_L1_OFFSET    = 4            # restored
    OSM_L2_OFFSET    = 7
    OSM_L3_OFFSET    = 11
    OSM_L1_SIZE      = 15           # restored
    OSM_L2_SIZE      = 12
    OSM_L3_SIZE      = 8
    OSM_MR_THRESH    = 7            # restored
    OSM_MR_MAX_QTY   = 20           # restored
    OSM_SKEW_FACTOR  = 0.06

    # ── TIMING ────────────────────────────────────────────────────────────
    ROUND_DAYS       = 3
    MAX_TS           = 99_900
    ENDGAME_START    = 97_000       # keep this improvement
